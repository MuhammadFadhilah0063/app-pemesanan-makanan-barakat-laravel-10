...
<div class="container-xxl pt-1 pb-3 py-lg-5 bg-dark hero-header mb-5">
  <div class="container text-center my-5 pt-5 pb-4">
    <h1 class="display-5 text-white mb-3 animated slideInDown">
      <span id="reservation-id" data-reservation-id="{{ $reservation->reservation_id }}">Reservasi Nomor {{
                    ...
                    <div class="row d-flex justify-content-between">
                      ...
                      <div class="col text-end">
                        <button class="btn btn-sm rounded-3 btn-success my-auto shadow-sm" id="btn_add_cart"
                          style="height: 30px; width: 30px" data-name="{{ $item->name }}" data-food-id=" {{ $item->food_id
