...
<body>
  <div class="invoice-box">
    <table cellpadding="0" cellspacing="0">
        ...
        <td colspan="2">
          <table>
            <tr>
              ...
              <td>
                No. Pesanan : <strong>{{ $order->online_order_id }}</strong><br>
                {{ formatDate($order->pick_up_date) }}<br>
              </td>
            </tr>
          </table>
        </td>
      ...
      <tr>
        <td>Metode Pembayaran : {{ ($order->payment_method == 'cash') ? 'COD/Tunai' : 'Virtual/Transfer' }}</td>
        <td></td>
      </tr>
      <tr>
