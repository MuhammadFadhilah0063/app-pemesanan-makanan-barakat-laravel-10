    ...
    <div class="row">
      <table>
        ...
        <tr>
          ...
          <td width="140px" style="text-align: left; text-transform: capitalize;">{{ $item->sale_id }}</td>
          <td width="163px">
        ...
        <tr>
          ...
          <th colspan="1">{{ ribu(count($sale)) }} Penjualan</th>
        </tr>
        <tr>
          <th colspan="3">Total Pendapatan</th>
          <th colspan="1">{{ rupiah($totalRevenue) }}</th>
        </tr>
      </table>
    </div>
