  ...
  <div class="body">
    ...
    <div class="header">
      ...
      <p id="title" class="text-center">
        Laporan Reservasi Offline
      </p>
      @else
      <p id="title" class="text-center">
        Laporan Semua Reservasi Offline
      </p>
      @endif
    ...
    <div class="row">
      <table>
        ...
        @endforeach
        <tr>
          <th colspan="5">Total Reservasi Status Pending</th>
          <th colspan="2">{{ ribu($pending) }} reservasi</th>
        </tr>
        <tr>
          <th colspan="5">Total Reservasi Status Process</th>
          <th colspan="2">{{ ribu($process) }} reservasi</th>
        </tr>
        <tr>
          <th colspan="5">Total Reservasi Status Success</th>
          <th colspan="2">{{ ribu($success) }} reservasi</th>
        </tr>
        <tr>
          <th colspan="5">Total Reservasi Status Failed</th>
          <th colspan="2">{{ ribu($failed) }} reservasi</th>
        </tr>
        <tr>
          <th colspan="5">Total Semua Reservasi</th>
