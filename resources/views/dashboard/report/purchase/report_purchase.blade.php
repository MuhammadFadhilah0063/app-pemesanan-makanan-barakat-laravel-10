    ...
    <div class="row">
      <table>
        ...
        <tr>
          ...
          <td width="140px" style="text-align: left; text-transform: capitalize;">{{ $item->purchase_id }}</td>
          <td width="190px" style="text-align: left; text-transform: capitalize;">{{ $item->raw_material->name }}</td>
          <td width="120px">
            {{ formatDate($item->purchase_date) }}
          </td>
          <td width="90px" style="text-transform: capitalize;">
            {{ ribu($item->quantity) }} ({{ $item->raw_material->unit }})
          </td>
          <td width="117px" style="text-align: left; text-transform: capitalize;">
          ...
          <td width="157px"
            style="text-align: @if ($item->supplier) left @else center @endif; text-transform: capitalize;">
            @if ($item->supplier)
            {{ $item->supplier->name }}
            @else
            -
        ...
        <tr>
          ...
          <th colspan="2">{{ ribu(count($purchase)) }} Pembelian</th>
        </tr>
        <tr>
