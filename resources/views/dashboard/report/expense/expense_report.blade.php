@extends('layouts/dashboard', ['title' => 'Dashboard - Expense Report'])
  ...
  <div class="col-lg-12">
    <div class="card mb-4">
      <div class="card-header pb-0 pt-3">
        <h5>Pilih Tahun dan Bulan Laporan Pengeluaran</h5>
        <hr class="m-0">
      </div>
...
@push('script')
@include('dashboard.report.expense.expense_report-script')
@endpush