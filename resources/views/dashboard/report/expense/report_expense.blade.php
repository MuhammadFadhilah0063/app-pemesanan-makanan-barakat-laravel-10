    ...
    <div class="row">
      <table>
        ...
        <tr>
          ...
          <td width="140px" style="text-align: left; text-transform: capitalize;">{{ $item->expense_id }}</td>
          <td width="210px" style="text-align: left; text-transform: capitalize;">{{ $item->description }}</td>
          <td width="163px">
        ...
        <tr>
          ...
          <th colspan="1">{{ ribu(count($expense)) }} Pengeluaran</th>
        </tr>
        <tr>
          <th colspan="4">Total</th>
          <th colspan="1">{{ rupiah($total) }}</th>
        </tr>
      </table>
    </div>
