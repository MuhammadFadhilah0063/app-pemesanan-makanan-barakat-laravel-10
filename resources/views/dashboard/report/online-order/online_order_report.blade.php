@extends('layouts/dashboard', ['title' => 'Dashboard - Online Order Report'])

@section('content')
{{-- Breadcrumb --}}
<nav aria-label="breadcrumb" class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">Laporan Pesanan Online</h1>
  <ol class="breadcrumb">
  ...
  <div class="col-lg-12">
    <div class="card mb-4">
      <div class="card-header pb-0 pt-3">
        <h5>Pilih Tahun dan Bulan Laporan Pesanan Online</h5>
        <hr class="m-0">
      </div>
...
@push('script')
@include('dashboard.report.online-order.online_order_report-script')
@endpush