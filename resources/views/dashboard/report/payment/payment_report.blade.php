@extends('layouts/dashboard', ['title' => 'Dashboard - Payment Report'])
  ...
  <div class="col-lg-12">
    <div class="card mb-4">
      <div class="card-header pb-0 pt-3">
        <h5>Pilih Tahun dan Bulan Laporan Pembayaran</h5>
        <hr class="m-0">
      </div>
...
@push('script')
@include('dashboard.report.payment.payment_report-script')
@endpush