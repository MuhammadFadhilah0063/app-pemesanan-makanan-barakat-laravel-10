  ...
  <div class="body">
    ...
    <div class="header">
      ...
      <p id="title" class="text-center">
        Laporan Pesanan Offline
      </p>
      @else
      <p id="title" class="text-center">
        Laporan Semua Pesanan Offline
      </p>
      @endif
    ...
    <div class="row">
      <table>
        ...
        <tr>
          ...
          <td width="140px" style="text-align: left; text-transform: capitalize;">{{ $item->offline_order_id }}</td>
          ...
          <td width="148px">{{ $item->status }} </td>
          <td width="170px" style="text-align: left; text-transform: capitalize;">
            {{ rupiah($item->total) }}
          </td>
        </tr>
        @endforeach
        <tr>
          <th colspan="4">Total Pesanan Status Process</th>
          <th colspan="2">{{ ribu($process) }} pesanan</th>
        </tr>
        <tr>
          <th colspan="4">Total Pesanan Status Success</th>
          <th colspan="2">{{ ribu($success) }} pesanan</th>
        </tr>
        <tr>
          <th colspan="4">Total Pesanan Status Failed</th>
          <th colspan="2">{{ ribu($failed) }} pesanan</th>
        </tr>
        <tr>
          <th colspan="4">Total Semua Pesanan</th>
