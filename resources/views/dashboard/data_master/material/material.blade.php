@extends('layouts/dashboard', ['title' => 'Dashboard - Raw Material'])
...
<!-- Modal Center -->
<div class="modal fade" id="modalMaterial" tabindex="-1" role="dialog" aria-labelledby="modalMaterialTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Tambah Bahan Baku</h5>
...
@push('script')
@include('dashboard.data_master.material.material-script')
@endpush